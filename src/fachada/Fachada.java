...
//		}
	...
	public static void excluirUsuario(String cpf) throws Exception {
		...
		System.out.println("deletar o usuario:" + u.getNomeUsuario());
	...
	public static void alterarPedido(Integer codigo, String novobairro, String novarua, String novonumero)
		...
		Endereco novoend = t.getEnderecoEntrega();
		novoend.setBairro(novobairro);
		novoend.setRua(novarua);
		novoend.setNumero(novonumero);
