...
//		}
	...
	// CADASTRANDO USUARIO
	public static Usuario cadastrarUsuario( String nome,String cpf,String  fone, String email, String senha,String cidade, String bairro, String rua, String numero) throws  Exception{
		DAO.begin();
	...
	//REALIZANDO PEDIDO
	public static Pedido realizarPedido(String uf,String cidade, String bairro, String rua, String numero,Integer quantidadeProduto, String nomeProduto, Float valorProduto, Float valorTotalPedido ) throws  Exception{
