...
public abstract class DAO<T> implements DAOInterface<T> {
	...
	public static void open() {
		if (manager == null) {
			...
			// propriedades.put(PersistenceUnitProperties.JDBC_DRIVER,
			// "org.postgresql.Driver" );
			// propriedades.put(PersistenceUnitProperties.JDBC_URL,
			// "jdbc:postgresql://localhost4:5432/agenda");
			...
			// propriedades.put(PersistenceUnitProperties.SCHEMA_GENERATION_DATABASE_ACTION,
			// "drop-and-create");
			// propriedades.put(PersistenceUnitProperties.SCHEMA_GENERATION_SCRIPTS_ACTION,
			// "create");
			// propriedades.put(PersistenceUnitProperties.SCHEMA_GENERATION_SCRIPTS_ACTION,
			// "create");
			// factory =
			// Persistence.createEntityManagerFactory("agenda-eclipselink-postgres",
			// propriedades);
